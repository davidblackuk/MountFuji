...
int main(int argc, char *argv[])
{
	...
	/* A hack to get the association between .mfhat files and hatari  */
	/* to launch hatari from maui. However the passed mfhat file is interpreted by*/
	/* Hatari as a disk image. So I set argc to 1 to make Hatari ignore all */
	/* Command line arguments (and so load hatari.cfg if present)*/
	/* DONOT USE THIS VERSION OF HATARI OTHER THAN WITH MOUNT FUJI*/
	argc = 1;
